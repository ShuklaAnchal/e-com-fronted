    ...
    <div className="min-h-screen flex flex-col bg-[#FAF7F2]">
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(197,168,128,0.05) 0%, transparent 70%)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      />
          ...
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            <div
              style={{
                ...
                height: 1,
                background:
                  "linear-gradient(90deg, transparent, #C5A880, transparent)",
                margin: "0 auto",
              }}
            />
          </div>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "linear-gradient(135deg, #C5A880 0%, #A68A5E 100%)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    margin: "0 auto 20px",
                    boxShadow:
                      "0 0 0 6px rgba(197,168,128,0.12), 0 8px 24px rgba(197,168,128,0.2)",
                  }}
                >
                  <span
                    style={{
              ...
              >
                {TABS.map((tab, i) => (
                  ...
                  >
                    ...
                    <span
                      style={{
                        color: activeTab === tab.id ? "#C5A880" : "#CBCBCB",
                        fontSize: 14,
                      }}
                    >
                      ›
                    ...
                    {editMode ? (
                      <form onSubmit={handleProfileSave}>
                        ...
                        <FormField
                          ...
                          onChange={(v) =>
                            setProfileForm({ ...profileForm, mobileNumber: v })
                          }
  ...
  return (
    ...
    >
      <div>
        ...
        {subtitle && (
          <p style={{ fontSize: 11, color: "#8E8E8E", letterSpacing: "0.1em" }}>
            {subtitle}
          </p>
        )}
      </div>
        ...
        >
          {items.slice(0, 4).map((item, idx) => (
            ...
            >
              ...
              <span style={{ fontSize: 10, color: "#C5A880" }}>
                × {item.quantity || 1}
              </span>
            </div>
          ))}
  ...
  return (
    <div
      style={{
        ...
        height: h,
        background:
          "linear-gradient(90deg, rgba(197,168,128,0.08) 25%, rgba(197,168,128,0.15) 50%, rgba(197,168,128,0.08) 75%)",

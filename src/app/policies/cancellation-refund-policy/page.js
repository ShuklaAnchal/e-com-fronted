...
const Page = () => {
  return (
    <div>
        <Header />
      <div className="w-full h-full mt-10 bg-white py-16 min-h-screen bg-white sm:py-16 lg:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 text-[#555] text-sm sm:text-base leading-7">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              Customers may request order cancellation before the product has
              been shipped.
            </li>
            <li>
          ...
          <p className="mb-8">
            In such cases, customers will be notified and eligible refunds will
            be processed.
          </p>
          ...
          <p className="mb-8">
            Banking or payment gateway delays may occur and are beyond our
            direct control.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-8">
            <li>
              Customers may be asked to return the product in certain cases.
            </li>
            <li>

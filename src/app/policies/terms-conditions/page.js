  ...
  return (
    <div className="w-full h-full mt-20 bg-white py-24 sm:py-12 md:py-16 px-4 sm:px-6 md:px-10 lg:px-16">
      <div className="max-w-5xl mx-auto text-[#5f5f5f] text-sm sm:text-[15px] md:text-base leading-7 sm:leading-8">
        ...
        {/* Intro */}
        <p className="mb-6">
          Welcome to Siyaas. These Terms & Conditions govern your access to and
          use of our website, products, services, and all related interactions.
        ...
        <p className="mb-8">
          If you do not agree with any part of these terms, you are advised not
        ...
        {[
          ...
          },
          {
            ...
            content: (
              <>
                <p className="mb-2">
                  All products sold by Siyaas are handcrafted and may naturally vary in:
                </p>
                <ul className="list-disc pl-5 sm:pl-6 space-y-2 mb-4">
                  <li>Color</li>
                  <li>Texture</li>
                ...
                <p className="mb-4">
                  Such variations are normal characteristics of handmade products
                  and shall not be treated as defects.
                </p>
                <p className="mb-2">
          ...
          },
          {
            ...
            content: (
              <>
                <h3 className="font-semibold text-base sm:text-lg mb-2">4.1 Pricing</h3>
                <p className="mb-2">
                ...
                <h3 className="font-semibold text-base sm:text-lg mb-2">4.2 Payment Methods</h3>
                <ul className="list-disc pl-5 sm:pl-6 space-y-2 mb-4">
                  <li>UPI</li>
                  <li>Debit cards</li>
                  <li>Credit cards</li>
                ...
                <h3 className="font-semibold text-base sm:text-lg mb-2">4.3 Failed Transactions</h3>
                <p>
                  Siyaas is not responsible for banking failures, gateway issues,
                  or unauthorized banking activity beyond our control.
                </p>
              </>
            ),
          },
          ...
          },
          {
            ...
            content: (
              <>
                ...
                <p>
                  Risk of loss and ownership transfers upon successful delivery.
                </p>
              </>
            ),
          },
          ...
          },
          {
            ...
            content: (
              <>
                ...
                <p>
                  Siyaas is not responsible for accidents or damages caused by misuse.
                </p>
              </>
            ),
          },
          {
            ...
            content: (
              <p>
                All Siyaas branding, logos, product images, content, and designs
                are protected intellectual property and may not be reused without permission.
              </p>
            ),
          },
          {
          ...
          },
          {
            ...
            content: (
              <p>
                User-generated content may be used by Siyaas for promotional and
                marketing purposes without additional compensation.
              </p>
            ),
          },
          {
          ...
          },
          {
            ...
            content: (
              <p>
                Website use is also governed by our Privacy Policy.
              </p>
            ),
          },
          {
            ...
            content: (
              <p>
                Siyaas may update or revise these Terms at any time without prior notice.
              </p>
            ),
          },
          {
            ...
            content: (
              <p>
                These Terms are governed by Indian law, with disputes subject to
                Indian courts.
              </p>
            ),
          },
        ...
        <section className="border-t border-gray-200 pt-8 mt-10">
          ...
          <p className="mb-4">
            For questions regarding these Terms & Conditions, customers may contact:
          </p>
